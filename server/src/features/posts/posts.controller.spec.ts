...
describe('PostsController', () => {
  ...
  const postsService: Partial<PostsService> = {
    getPosts() { return 'test read' as any },
    getSinglePost() { return 'test read one' as any },
    createPost() { return 'test create' as any },
    updatePost() { return 'test update' as any },
    likePost() { return 'test like' as any },
    flagPost() { return 'test flag' as any },
    lockPost() { return 'test lock' as any },
    deletePost() { return 'test delete' as any },
  }
  ...
  describe('updatePost method', () => {
    it('should call the PostsService updatePost method with correct arguments', async () => {
      ...
      expect(postsService.updatePost).toHaveBeenCalledWith(updateDTO, 4, user, true);
